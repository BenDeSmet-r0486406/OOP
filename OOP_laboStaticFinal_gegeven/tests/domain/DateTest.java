...
{
    private final Date date = new Date( 1, 1, 2000 );
    private Date dayInFebruariNonLeap;
    private final Date februari29Leap = new Date(29, 2, 2000);
    ...
    public void test_Date_creates_date_for_valid_day_month_year_combinations() {
        ...
        assertEquals( 29, februari29Leap.getDay() );
        assertEquals( 2, februari29Leap.getMonth() );
        assertEquals( 2000, februari29Leap.getYear() );
    }
