...
public class Opdracht {
	...
	public boolean equals(Object object) {
		...
		if(object instanceof Opdracht){
			...
			if (this.getAntwoord().equals(o.getAntwoord()) && this.getAntwoordHint().equals(o.getAntwoordHint()) && this.getAuteur().equals(o.getAuteur()) && this.getCategorie().equals(o.getCategorie()) && this.getVraag().equals(o.getVraag()) ){
				gelijk = true;
			}
		}
